...
• Slide 3 — DADO/VIRADA (layout "foto_cheia", corFundo "preto"): número ou fato que sustenta a tese. kicker + headline + destaque.
...
• Slide 5 — PERFIL/IMPLICAÇÃO (layout "split_invertido", corFundo "amarelo"): quem ou o que muda. kicker + headline + corpo.
...
COR DE FUNDO: já fixada na estrutura acima (slides 1, 2, 3, 6 e 7 = "preto"; slides 4 e 5 = "amarelo"). Mantenha assim.
