...
/**
 * Painel global de "Estilo visual" — v7.8.
 * A estética e o negative prompt aqui valem para TODAS as imagens da sessão.
 * O IMGPROMPT de cada slide descreve só a cena; estética/proporção são globais.
 */
