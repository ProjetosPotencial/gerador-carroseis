...
export interface SlideData {
  ...
  /** Prompt de CENA da imagem (campo IMGPROMPT do "Colar conteúdo"). */
  imgPrompt?: string;
  /** Estado da geração: idle | gerando | ok | erro. */
  imgStatus?: "idle" | "gerando" | "ok" | "erro";
  /** Mensagem curta de erro da última geração. */
  imgErro?: string;
  /** Origem da foto atual: "ia" (gerada) ou "manual" (upload/URL). */
  ...
  fotoOffsetX?: number;
  /** v7.7.23: offset Y da foto em % (-50 a +50, default 0). */
  fotoOffsetY?: number;
...
export interface LayoutRenderProps {
  ...
  ehUltimo?: boolean;
  /** v7.7.23: callback de drag da foto principal. Quando undefined, drag desativado (modo export). */
