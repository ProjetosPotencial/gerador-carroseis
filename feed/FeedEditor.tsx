...
import { useImagens, EstiloVisualPanel } from "../carrossel";
...
export default function FeedEditor() {
  ...
  // v7.8 — geração de imagem por IA (reusa o hook do carrossel).
  // Adaptador: o Feed usa Status próprio {tipo,msg}; mapeamos p/ sucesso/erro.
  ...
  const img = useImagens<FeedSlideData>({
    ...
    // Feed = 4:5, Stories = 9:16 — pelo prefixo do templateId
        ...
        >
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            ...
            <button
              ...
              title={
                img.slidesPendentes === 0
                  ? "Nenhum slide com IMGPROMPT pendente"
                  : "Gera a imagem de todos os slides com IMGPROMPT sem foto"
              }
            >
              {img.gerandoLote ? (
                <>
        ...
        <Secao titulo="Foto deste slide" icone={<ImageIcon size={12} />}>
          ...
          <div
            style={{
              ...
              borderRadius: 8,
              background: "#0f0f0f",
              border: "1px solid rgba(255,197,40,0.25)",
            }}
          >
            ...
            />
            <p style={{ fontSize: 10, color: "#777", margin: "6px 0 0" }}>
              Estética e proporção vêm do "Estilo visual" global. Aqui só a cena.
            </p>
            ...
            <button
              ...
              style={{
                ...
                fontWeight: 700,
                cursor: "pointer",
                border: slide.fotoOrigem === "ia" && slide.fotoUrl ? "1px solid #444" : "none",
                background: slide.fotoOrigem === "ia" && slide.fotoUrl ? "#1a1a1a" : "#FFC528",
                color: slide.fotoOrigem === "ia" && slide.fotoUrl ? "#eee" : "#000",
                opacity:
                  slide.imgStatus === "gerando" || !(slide.imgPrompt || "").trim() ? 0.45 : 1,
              }}
            >
              {slide.imgStatus === "gerando" ? (
                <>
                  <Loader2 size={13} className="animate-spin" /> Gerando…
                </>
              ) : slide.fotoOrigem === "ia" && slide.fotoUrl ? (
                <>
                  <RefreshCcw size={13} /> Regerar variação
                </>
              ) : (
                <>
